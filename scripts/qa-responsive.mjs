...
// На старте контента нет → проверяем хабы (они строятся пустыми). Когда появятся
// статьи — добавить сюда 1–2 контентные страницы с широкими таблицами/длинными
// кредит-URL (анти-overflow `.prose table`/`figcaption`).
const PAGES = ['/', '/attractions/', '/cities/', '/car-rental/', '/food/', '/entertainment/', '/insurance/', '/routes/', '/news/', '/planning/', '/relocation/'];
