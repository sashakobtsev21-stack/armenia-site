...
export default defineConfig({
  // Прод-домен (off-domain: куплен/подключается, индексация закрыта robots до запуска).
  site: 'https://armeniaguidebook.com',
  ...
  integrations: [
    // Карта сайта (§14). EN-first: на старте сайт одноязычный (LANGS=['en'], корень).
    // ru-движок донора (montenegro) оставлен ДОРМАНТНЫМ (i18n/ru.ts и ru-компоненты
    // есть, но ru-контента нет) — поэтому в карте только en. Когда ru-кластер
    // релокации включат флипом LANGS=['en','ru'] — вернуть ru в locales (взаимные
